...
- `og:image` is an absolute URL hardcoded to `https://mosaic-code-coop.github.io/test-data-api/og-image.jpg`; if the org/repo is renamed update `index.html` and `useFactory.ts` (issue-link permalink).
